...
import me.arwan.mov.core.utils.convertTime
...
fun InfoCardMovie(
    ...
    val dateMovie = remember {
        movie.releaseDate?.convertTime() ?: context.getString(R.string.sub_title_time_movie)
    }
    val voteAverage = remember { (movie.voteAverage * 10).toInt() }

    Column(
        modifier = modifier.padding(10.dp),
        verticalArrangement = Arrangement.Center
    ) {
        OriginalTitleMovie(originalTitle = movie.title)
